...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800 selection:bg-emerald-200 selection:text-emerald-900">
      <Helmet>
        <title>Empresa de Reformas en San Martín de Valdeiglesias | Presupuesto Gratis</title>
        <meta name="description" content="Especialistas en reformas integrales, baños y cocinas en San Martín de Valdeiglesias. Más de 20 años de experiencia. Pide tu presupuesto sin compromiso." />
      </Helmet>
      <main>
        {/* Hero Section */}
        ...
        <section className="py-16 md:py-24 bg-slate-50 border-t border-slate-200">
          <div className="container mx-auto px-4 max-w-7xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              {/* Service 3 */}
              <article className="group bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-xl transition-all duration-300 cursor-pointer">
                <Link to="/reformas-de-cocinas" className="block h-full w-full">
                  <div className="h-64 overflow-hidden relative">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-slate-900/20 to-transparent opacity-80"></div>
                    <div className="absolute bottom-6 left-6 right-6">
                      <h3 className="text-2xl font-bold text-white mb-2">Reforma de Cocinas</h3>
