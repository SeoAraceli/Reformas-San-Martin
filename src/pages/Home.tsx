            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
              ...
              <div className="max-w-2xl mx-auto lg:mx-0 text-center lg:text-left">
                ...
                <p className="text-lg md:text-xl text-slate-600 leading-relaxed mb-10">
                  Somos la empresa de <strong>reformas en San Martín de Valdeiglesias</strong> de referencia. Transformamos tus espacios con un servicio premium de reformas integrales, baños y cocinas. <span className="font-semibold text-slate-800">Calidad garantizada</span> y más de 20 años de experiencia profesional en cada proyecto de renovación para tu hogar o local comercial.
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                  ...
                  <a href="tel:+34640839282" className="w-full sm:w-auto bg-white hover:bg-slate-50 text-slate-800 font-semibold py-4 px-6 md:px-8 rounded-xl text-base md:text-lg transition-all shadow-sm border border-slate-200 hover:border-slate-300 hover:-translate-y-0.5 flex items-center justify-center gap-2">
              ...
              <div className="relative lg:h-[600px] w-full max-w-lg mx-auto lg:max-w-none mt-10 lg:mt-0">
                ...
                <div className="relative w-full h-[400px] lg:h-full rounded-[2.5rem] overflow-hidden shadow-2xl transform lg:rotate-2 hover:rotate-0 transition-transform duration-500 border-4 border-white">
                  ...
                  <img 
                    ...
                    alt="Proyecto de reforma integral en San Martín de Valdeiglesias" 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="relative">
                <div className="relative rounded-[2rem] overflow-hidden shadow-xl aspect-[4/5] lg:aspect-auto lg:h-[600px]">
                  <img 
                    ...
                    alt="Especialistas en reformas integrales" 
                    className="w-full h-full object-cover"
                    referrerPolicy="no-referrer"
                    loading="lazy"
                    decoding="async"
              ...
              <div>
                ...
                <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6 tracking-tight leading-tight text-center lg:text-left">
                  Especialistas en <span className="text-emerald-600">Reformas Integrales en San Martín de Valdeiglesias</span>
                </h2>
                <p className="text-base md:text-lg text-slate-600 leading-relaxed mb-6 text-center lg:text-left">
                  En <strong>Reformas San Martín de Valdeiglesias</strong> entendemos que tu hogar o negocio es tu espacio más importante. Por eso, nos dedicamos a transformar tus ideas en realidad con un nivel de detalle y compromiso inigualable en toda la zona y alrededores.
                </p>
                <p className="text-base md:text-lg text-slate-600 leading-relaxed mb-10 text-center lg:text-left">
                  Nuestro equipo de profesionales abarca todos los gremios (albañilería, fontanería, electricidad, carpintería), permitiéndonos ofrecer un servicio "llave en mano" donde tú no tienes que preocuparte por nada.
                </p>
          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <div className="text-center mb-16 max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6 tracking-tight">
                Nuestros Servicios de Reforma en San Martín de Valdeiglesias
              </h2>
              <p className="text-lg text-slate-600 leading-relaxed">
                Cubrimos todas las necesidades de tu proyecto con especialistas en cada área. Desde pequeñas actualizaciones hasta reformas integrales llave en mano en San Martín de Valdeiglesias y localidades cercanas.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <article className="group bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-xl transition-all duration-300">
                <div className="h-64 overflow-hidden relative">
                  <img src="https://www.6mejores.com/wp-content/uploads/2026/02/empresa-de-reformas-reformas-integrales.jpg" alt="Reformas Integrales" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" referrerPolicy="no-referrer" loading="lazy" decoding="async" />
                  ...
                  <div className="absolute bottom-6 left-6 right-6">
                    <h3 className="text-2xl font-bold text-white mb-2">Reformas Integrales</h3>
                    <p className="text-slate-200 text-sm line-clamp-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-4 group-hover:translate-y-0">Transformamos tu vivienda por completo en San Martín de Valdeiglesias, coordinando todos los gremios para un resultado llave en mano.</p>
                  </div>
                </div>
              </article>
              ...
              <article className="group bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-xl transition-all duration-300">
                <div className="h-64 overflow-hidden relative">
                  <img src="https://www.6mejores.com/wp-content/uploads/2026/02/reforma-bano.jpg" alt="Reforma de Baños" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" referrerPolicy="no-referrer" loading="lazy" decoding="async" />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-slate-900/20 to-transparent opacity-80"></div>
                  <div className="absolute bottom-6 left-6 right-6">
                    <h3 className="text-2xl font-bold text-white mb-2">Reforma de Baños</h3>
                    <p className="text-slate-200 text-sm line-clamp-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-4 group-hover:translate-y-0">Modernizamos tu baño con los mejores materiales, sanitarios y platos de ducha para maximizar el confort en tu hogar.</p>
                  </div>
                </div>
              </article>
              ...
              {/* Service 3 */}
              <article className="group bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-xl transition-all duration-300">
                <Link to="/reformas-de-cocinas-san-martin-de-valdeiglesias" className="block h-64 overflow-hidden relative">
                  <img src="https://www.6mejores.com/wp-content/uploads/2026/02/reforma-cocina.jpg" alt="Reforma de Cocinas" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" referrerPolicy="no-referrer" loading="lazy" decoding="async" />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-slate-900/20 to-transparent opacity-80"></div>
                  <div className="absolute bottom-6 left-6 right-6">
                    <h3 className="text-2xl font-bold text-white mb-2 flex items-center gap-2">Reforma de Cocinas <ArrowRight size={20} className="opacity-0 group-hover:opacity-100 transition-opacity" /></h3>
                    <p className="text-slate-200 text-sm line-clamp-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-4 group-hover:translate-y-0">Diseñamos y montamos cocinas funcionales, modernas y a medida, adaptadas a tu estilo de vida y necesidades.</p>
                  </div>
                </Link>
              </article>
              ...
              <article className="group bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-xl transition-all duration-300">
                <div className="h-64 overflow-hidden relative">
                  <img src="https://www.6mejores.com/wp-content/uploads/2026/02/reforma-integrales-locales-comerciales.jpg" alt="Locales Comerciales" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" referrerPolicy="no-referrer" loading="lazy" decoding="async" />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-slate-900/20 to-transparent opacity-80"></div>
                  <div className="absolute bottom-6 left-6 right-6">
                    <h3 className="text-2xl font-bold text-white mb-2">Locales Comerciales</h3>
                    <p className="text-slate-200 text-sm line-clamp-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-4 group-hover:translate-y-0">Acondicionamos tu negocio para atraer más clientes, optimizando el espacio y la imagen corporativa.</p>
                  </div>
                </div>
              </article>
              ...
              <article className="group bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-xl transition-all duration-300">
                <div className="h-64 overflow-hidden relative">
                  <img src="https://www.6mejores.com/wp-content/uploads/2026/02/reformas-carpinteria-y-suelos.jpg" alt="Carpintería y Suelos" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" referrerPolicy="no-referrer" loading="lazy" decoding="async" />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-slate-900/20 to-transparent opacity-80"></div>
                  <div className="absolute bottom-6 left-6 right-6">
                    <h3 className="text-2xl font-bold text-white mb-2">Carpintería y Suelos</h3>
                    <p className="text-slate-200 text-sm line-clamp-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-4 group-hover:translate-y-0">Instalación de tarimas, parquets, puertas y armarios a medida con acabados de primera calidad.</p>
                  </div>
                </div>
              </article>
              ...
              <article className="group bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-xl transition-all duration-300">
                <div className="h-64 overflow-hidden relative">
                  <img src="https://www.6mejores.com/wp-content/uploads/2026/02/rehabilacion-fachadas-empresa-de-reformas.jpg" alt="Rehabilitación de Fachadas" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" referrerPolicy="no-referrer" loading="lazy" decoding="async" />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-slate-900/20 to-transparent opacity-80"></div>
                  <div className="absolute bottom-6 left-6 right-6">
                    <h3 className="text-2xl font-bold text-white mb-2">Rehabilitación de Fachadas</h3>
                    <p className="text-slate-200 text-sm line-clamp-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-4 group-hover:translate-y-0">Mejoramos el aislamiento térmico y la estética exterior de tu edificio o vivienda unifamiliar.</p>
                  </div>
                </div>
              </article>
            </div>
            ...
            <div className="mt-16 text-center px-4">
              <a href="#contacto" className="flex w-full sm:inline-flex sm:w-auto justify-center items-center gap-2 bg-slate-900 hover:bg-slate-800 text-white font-bold py-4 px-8 rounded-full transition-colors shadow-lg group">
                Solicitar presupuesto para mi reforma <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
              </a>
            </div>
          </div>
        </section>
